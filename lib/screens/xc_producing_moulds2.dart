...
class XcProducingMoulds2 extends StatefulWidget {
  static const routeName = 'XcProducingMoulds2';

  XcProducingMoulds2({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _XcProducingMoulds2State createState() => _XcProducingMoulds2State();
}
...
class _XcProducingMoulds2State extends State<XcProducingMoulds2> {
  getData() async {
    colNames = [];
    //var url = 'https://c00c9f1e.ngrok.io/5';
    var response = await http.get(url+"/5");
