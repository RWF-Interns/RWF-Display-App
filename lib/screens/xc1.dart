...
class Xc1 extends StatefulWidget {
  static const routeName = 'Xc1';

  Xc1({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Xc1State createState() => _Xc1State();
}
...
class _Xc1State extends State<Xc1> {
  getData() async {
    colNames = [];
    var url = 'https://c00c9f1e.ngrok.io/1';
