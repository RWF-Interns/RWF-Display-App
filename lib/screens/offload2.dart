...
class Offload2 extends StatefulWidget {
  static const routeName = 'Offload2';

  Offload2({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Offload2State createState() => _Offload2State();
}
...
class _Offload2State extends State<Offload2> {
  getData() async {
    colNames = [];
    //var url = 'https://c00c9f1e.ngrok.io/14';
    var response = await http.get(url+"/14");
