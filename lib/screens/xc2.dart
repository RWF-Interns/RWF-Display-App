...
class Xc2 extends StatefulWidget {
  static const routeName = 'Xc2';

  Xc2({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Xc2State createState() => _Xc2State();
}
...
class _Xc2State extends State<Xc2> {
  getData() async {
    colNames = [];
    var url = 'https://c00c9f1e.ngrok.io/2';
