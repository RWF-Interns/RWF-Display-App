...
class Rht1 extends StatefulWidget {
  static const routeName = 'Rht1';

  Rht1({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Rht1State createState() => _Rht1State();
}
...
class _Rht1State extends State<Rht1> {
  getData() async {
    colNames = [];
    //var url = 'https://c00c9f1e.ngrok.io/7';
    var response = await http.get(url+"/7");
