...
class Offload1 extends StatefulWidget {
  static const routeName = 'Offload1';

  Offload1({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Offload1State createState() => _Offload1State();
}
...
class _Offload1State extends State<Offload1> {
  getData() async {
    colNames = [];
    //var url = 'https://c00c9f1e.ngrok.io/13';
    var response = await http.get(url+"/13");
