...
class Offload3 extends StatefulWidget {
  static const routeName = 'Offload3';

  Offload3({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Offload3State createState() => _Offload3State();
}
...
class _Offload3State extends State<Offload3> {
  getData() async {
    colNames = [];
    //var url = 'https://c00c9f1e.ngrok.io/15';
    var response = await http.get(url+"/15");
