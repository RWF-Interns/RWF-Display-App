...
class Xc3 extends StatefulWidget {
  static const routeName = 'Xc3';

  Xc3({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Xc3State createState() => _Xc3State();
}
...
class _Xc3State extends State<Xc3> {
  getData() async {
    colNames = [];
    //var url = 'https://c00c9f1e.ngrok.io/3';
    var response = await http.get(url+"/3");
