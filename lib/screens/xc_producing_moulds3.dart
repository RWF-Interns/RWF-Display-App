...
class XcProducingMoulds3 extends StatefulWidget {
  static const routeName = 'XcProducingMoulds3';

  XcProducingMoulds3({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _XcProducingMoulds3State createState() => _XcProducingMoulds3State();
}
...
class _XcProducingMoulds3State extends State<XcProducingMoulds3> {
  getData() async {
    colNames = [];
    //var url = 'https://c00c9f1e.ngrok.io/6';
    var response = await http.get(url+"/6");
